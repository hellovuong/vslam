...
int main(int argc, char **argv)
{
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            // cv::resize(imRight,imRight,cv::Size(640,360));
...
void LoadImages(const string &strPathFolder, vector<string> &vstrImageLeft, vector<string> &vstrImageRight, vector<double> &vTimeStamps)
{
    string strPathLeft = strPathFolder + "/d455_color";
    string strPathRight = strPathFolder + "/d455_infra2";
    string strPathTimesLeft = strPathFolder +"/d455_times_color.txt";
    string strPathTimesRight = strPathFolder +"/d455_times_infra2.txt";
    ifstream fTimes;
